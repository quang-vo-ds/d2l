...
# -*- coding: utf-8 -*-
"""
Created on Sat Jun 17 08:33:11 2023
...
def show_images(imgs, num_rows, num_cols, titles=None, scale=1.5):  #@save
    ...
    _, axes = mylib.plt.subplots(num_rows, num_cols, figsize=figsize)
    axes = axes.flatten()
...
class Trainer(HyperParameters):
    ...
    def __init__(self, max_epochs, num_gpus=0, gradient_clip_val=0):
        self.save_hyperparameters()
        self.gpus = [gpu(i) for i in range(min(num_gpus, mylib.num_gpus()))]
...
class Classifier(mylib.Module):
    ...
    def accuracy(self, Y_hat, Y, averaged=True):
        ...
        preds = torch.argmax(Y_hat, axis=1).type(Y.dtype)
...
if __name__ == '__main__':
    for attribute in dir(mylib.Classifier):
